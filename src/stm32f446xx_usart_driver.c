 ...
 *
 * @param[in]         - handle structure for the USARTx peripheral
 * @param[in]         -
 * @param[in]         -
 *
 * @return            -  none
...
void USART_Init(USART_Handle_t *pUSARTHandle)
{
	...
	if ( pUSARTHandle->USART_Config.USART_ParityControl == USART_PARITY_EN_EVEN){
		...
		//EVEN by default so no change in PS bit
 ...
 *
 * @param[in]         - base address of the USART peripheral we want to de-initialize
 * @param[in]         -
 * @param[in]         -
 *
 * @return            -  none
 ...
 * @fn      		  - USART_SendData
 *
 * @brief             - This function is for sending data with the USART peripheral
 *
 * @param[in]         - handle structure for USART peripheral
 * @param[in]         - base address of data to sent
 ...
 *
 * @brief             - This function is for receiving data with the USART peripheral
 *
 * @param[in]         - handle structure for USART peripheral
 * @param[in]         - base address of data to sent
 * @param[in]         - length of data
   ...
   //Loop over until "Len" number of bytes are transferred
	for(uint32_t i = 0 ; i < Len; i++){
		...
		if(pUSARTHandle->USART_Config.USART_WordLength == USART_WORDLEN_9BITS){
			...
			//check if we are using USART_ParityControl control or not
			if(pUSARTHandle->USART_Config.USART_ParityControl == USART_PARITY_DISABLE){
 ...
 * @fn      		  - USART_SendDataIT
 *
 * @brief             - This function is for preparing the USART peripheral
 * 						to send data in interrupt mode
 *
 * @param[in]         - handle structure for USART peripheral
 * @param[in]         - base address of data to sent
 * @param[in]         - length of data
 *
 * @return            - the state of the transmitting line
 *
 * @Note              - none
 */
 ...
 *
 * @brief             - This function is for preparing the USART peripheral
 * 						to receive data in interrupt mode
 *
 * @param[in]         - handle structure for USART peripheral
 * @param[in]         - base address of data to sent
 * @param[in]         - length of data
 *
 * @return            - the state of the receiving line
 *
 * @Note              - none
 */
 ...
 *
 * @brief             - This function enables or disables the interrupts for USARTx
 *
 ...
 *
 * @brief             - This function configures the priority of the interrupts for USARTx
 *
 * @param[in]         - the IRQNumber of the interrupt
 * @param[in]         - ENABLE or DISABLE macros
 * @param[in]         -
 ...
 * @fn      		  - USART_IRQHandler
 *
 * @brief             - This function is for handling the UART interrupts
 *
 * @param[in]         - handle structure of the USART peripheral
 * @param[in]         -
 * @param[in]         -
 *
 * @return            - none
 ...
 * @fn      		  - USART_ClearFlag
 *
 * @brief             - This function is a helper function to clear the given flag
 * 						in the USART status register
 *
 * @param[in]         - base address of the USART peripheral
 * @param[in]         - the bit of the flag we want
 ...
 *
 * @brief             - This is h helper function to configure the baudrate
 *
